...
const FName ATinyShooter1Pawn::FireForwardBinding("FireForward");
const FName ATinyShooter1Pawn::FireRightBinding("FireRight");

ATinyShooter1Pawn::ATinyShooter1Pawn()
{	
...
void ATinyShooter1Pawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
